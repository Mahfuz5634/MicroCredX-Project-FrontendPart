...
const Carousel = () => {
  ...
  return (
    <motion.div initial={{ scale: 0 }} animate={{ scale: 1 , transition: { duration: 0.4 }}} className="overflow-hidden ">
      <Slider {...settings}>
          ...
          <div key={idx} className="relative h-[260px] md:h-[460px]">
            ...
            <div className="absolute inset-0 flex items-center">
              <div className="px-6 md:px-12">
                <div className="max-w-xl   border-emerald-400/40 rounded-xl px-5 py-4 md:px-8 md:py-6 shadow-lg">
