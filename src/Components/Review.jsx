  ...
  return (
    <ScrollReveal>
      <section className="mt-16 mb-10 ">
        <div className="text-center mb-8 container mx-auto px-2">
          ...
          <p className="mt-2 text-sm text-slate-500 max-w-xl mx-auto">
            Short stories from customers who used MicroCredX to manage
            education, business, and emergency microloans.
          </p>
        </div>
          ...
          <Slider {...settings}>
            {feedbacks.map((item) => (
              <div key={item.id} className="px-2">
                <div className="relative h-full flex flex-col rounded-2xl border border-slate-200 bg-white/90 backdrop-blur-sm px-4 py-5 md:px-6 md:py-7 shadow-sm">
                  {/* quote mark */}
